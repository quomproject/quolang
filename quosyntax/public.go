...
// ParseConfig parses the given buffer as a whole Quo config file, returning
...
//
// The body in the returned file has dynamic type *quosyntax.Body, so callers
// may freely type-assert this to get access to the full quosyntax API in
...
// ParseExpression parses the given buffer as a standalone Quo expression,
...
// ParseTemplate parses the given buffer as a standalone Quo template,
// returning it as an instance of Expression.
